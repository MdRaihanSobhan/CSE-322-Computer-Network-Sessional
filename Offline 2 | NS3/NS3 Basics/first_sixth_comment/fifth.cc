...
// An assumed number of packets/data a sender can send
// before receiving acknowledgement from a receiver
/**
...
main(int argc, char* argv[])
{
    ...
    NS_LOG_INFO(InetSocketAddress(Ipv4Address::GetAny(), sinkPort));
    ...
    // When a packet is dropped in the physical layer of a NetDevice
