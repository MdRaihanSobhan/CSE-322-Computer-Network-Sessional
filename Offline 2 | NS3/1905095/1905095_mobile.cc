...
main(int argc, char* argv[])
{
    ...
    cmd.AddValue("nSpeed", "Speed of the nodes", nSpeed);
    cmd.Parse(argc, argv);
    ...
    if (tracing)
    {
        ...
        pointToPoint.EnablePcapAll("scratch/1905095/1905095_mobile");
        phy1.EnablePcap("scratch/1905095/1905095_mobile", leftApDevices.Get(0));
        phy2.EnablePcap("scratch/1905095/1905095_mobile", rightApDevices.Get(0));
    ...
    pd_ratio*=100.0;
    if(plot==1){
        std::ofstream outputFile("scratch/1905095/node.txt", std::ios::app);
        outputFile<<nNodes<<"\t"<<throughput<<"\t"<<pd_ratio<<"\n";
        outputFile.close();
    }
    else if(plot==2){
        std::ofstream outputFile("scratch/1905095/flow.txt", std::ios::app);
        outputFile<<nFlows<<"\t"<<throughput<<"\t"<<pd_ratio<<"\n";
        outputFile.close();
    }
    else if(plot==3){
        std::ofstream outputFile("scratch/1905095/packet.txt", std::ios::app);
        outputFile<<nPackets<<"\t"<<throughput<<"\t"<<pd_ratio<<"\n";
        outputFile.close();
    }
    else if(plot==4){
        // std::ofstream outputFile("scratch/1905095/coverage.txt", std::ios::app);
        // outputFile<<nCArea<<"\t"<<throughput<<"\t"<<pd_ratio<<"\n";
        // outputFile.close();
    }
    else if(plot==5){
        std::ofstream outputFile("scratch/1905095/speed.txt", std::ios::app);
